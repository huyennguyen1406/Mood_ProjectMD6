...
public interface IPlaylistRepository extends JpaRepository<Playlist, Long> {
    ...
    @Query(value = "select id_playlist, date_create_playlist, description_playlist, last_modifier_playlist, name_playlist, number_of_view_playlist, id_user from playlist" +
